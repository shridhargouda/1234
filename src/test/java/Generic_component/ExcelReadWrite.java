...
public class ExcelReadWrite {
	...
	public void writecell(HSSFSheet Sheet,int rowIndex,int cellnum, String wvalue ) throws IOException
	{
		//writing the cell
	...
	public void writecell(HSSFSheet Sheet,int rowIndex,String colname, String wvalue ) throws IOException{
		int colindex = 0;
		for(int i=0;i<getcolcount(Sheet,0);i++){
